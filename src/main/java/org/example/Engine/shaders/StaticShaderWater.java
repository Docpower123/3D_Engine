...
public class StaticShaderWater extends ShaderProgram {

    private static final String VERTEX_FILE = "src/Engine/shaders/vertexShaderWater.glsl";
    private static final String FRAGMENT_FILE = "src/Engine/shaders/fragmentShaderWater.glsl";
