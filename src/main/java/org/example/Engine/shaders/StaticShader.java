...
public class StaticShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "src/main/java/org/example/Engine/shaders/vertexShader.glsl";
    private static final String FRAGMENT_FILE = "src/main/java/org/example/Engine/shaders/fragmentShader.glsl";
