...
public class TerrainShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "src/main/java/org/example/Engine/terrains/terrainVertexShader.glsl";
    private static final String FRAGMENT_FILE = "src/main/java/org/example/Engine/terrains/terrainFragmentShader.glsl";
